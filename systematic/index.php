...
<html lang="en">
    ...
    <body>
        ...
        <div class="game-body">
            ...
            <div class="columns">
                <a href='../standard/question<?php echo rand(0,50) ?>.php?score=<?php echo 0; ?>&count=<?php echo 1; ?>'>
                ...
                <a href="question1.php?score=<?php echo 0; ?>&count=<?php echo 1; ?>">
                    <div class="row pro">
