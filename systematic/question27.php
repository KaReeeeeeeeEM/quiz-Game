...
<html lang="en">
    ...
    <body>
        ...
        <div class="game-body">
            ...
            <div class="columns">
                    <button class="row standard click" onclick='this.style.backgroundColor = "red"; var ran = Math.ceil(Math.random() * 50); window.location.href = `question28.php?score=<?php echo $score ?>&count=<?php echo $count + 1 ?>`;'>8</button>
                    <button class="row click" onclick='this.style.backgroundColor = "red"; var ran = Math.ceil(Math.random() * 50); window.location.href = `question28.php?score=<?php echo $score ?>&count=<?php echo $count + 1 ?>`;'>6</button>
                    <button class="row correct" id="correct" onclick="addScore()">4</button>
                    <button class="row click" onclick='this.style.backgroundColor = "red"; var ran = Math.ceil(Math.random() * 50); window.location.href = `question28.php?score=<?php echo $score ?>&count=<?php echo $count + 1 ?>`;'>16</button>
            </div>
        </div>
        ...
        <script>
            ...
            let addScore = () => {
                ...
                window.location.href = `question28.php?score=<?php echo $score + 1 ?>&count=<?php echo $count + 1 ?>`; 
            }
