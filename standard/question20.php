...
<html lang="en">
    ...
    <body>
        ...
        <div class="game-body">
            ...
            <div class="columns">
                    <button class="row standard click" onclick='this.style.backgroundColor = "red"; var ran = Math.ceil(Math.random() * 50); window.location.href = `question${ran}.php?score=<?php echo $score ?>&count=<?php echo $count + 1 ?>`;'>3</button>
